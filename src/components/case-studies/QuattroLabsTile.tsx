  ...
  return (
    ...
    >
      ...
      <div className="case-study-tile__content">
        <span className="case-study-tile__tag">Built by us · Auto · 150K+ followers</span>
        <h3 className="case-study-tile__firm">Quattro Labs</h3>
        <p className="case-study-tile__result">
          We built our own automotive brand to 150K+ followers. The same playbook we run for clients.
        </p>
      </div>
    </Link>
  );
